...
public class Constant {
    ...
    public static int START_NUMBER = 1; // 랜덤 시작 숫자
    public static int END_NUMBER = 9; // 끝 숫자
    public static int NUMBER_LENGTH = 3; // 숫자 길이, 사용시 객체 0부터 시작
    public static int STRIKE_OUT_COUNT = 3;

    public static String GAME_RESTART= "1";
    public static String GAME_EXIT = "2";
    ...
    public static String STRIKE_OUT = "3개의 숫자를 모두 맞히셨습니다! 게임 종료.";

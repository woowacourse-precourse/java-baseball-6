...
- [x] 게임 시작 가이드 메시지 출력 기능
- [x] 숫자 입력 가이드 메시지 출력 기능
- [x] 게임 결과 출력 기능
- [x] 게임 종료 가이드 메시지 출력 기능
  - [x] 게임 종료 가이드 메시지 출력
  - [x] 새로 시작 또는 종료 가이드 메시지 출력

### GameController: 게임에 필요한 객체들의 행동을 조율하고 관리할 책임
- [x] 게임이 끝날 때 까지 객체들에게 요청을 보내는 기능(게임 실행)
  - [x] 게임 시작
    - [x] 1번의 게임을 끝날때 까지 진행
    - [x] 게임이 끝나면 재시작 or 종료
...
- [x] Balls로 변환하는 기능
  - 외부에 공개할 필요없는 기능
- [x] 컴퓨터와 플레이어의 게임 숫자를 비교해 게임 결과를 생성하는 기능
  - [x] 컴퓨터의 게임 숫자 하나와 플레이어의 게임 숫자 하나를 차례대로 비교 

### BallsRule: 게임 숫자 규칙을 관리할 책임
- [x] 게임 숫자가 범위에서 벗어나는지 알려주는 기능
- [x] 위치 값이 범위에서 벗어나는지 알려주는 기능
...
### GameResult: 게임 결과를 관리할 책임
- [x] 스트라이크인 경우 스트라이크 개수 증가
- [x] 볼인 경우 볼 개수 증가
- [x] 게임결과가 `낫싱`인지 알려주는 기능
- [x] 게임이 끝났는지 알려주는 기능
- [x] 볼만 존재하는지 알려주는 기능
- [x] 스트라이크만 존재하는지 알려주는 기능

### GameResultMessage: 게임 결과 메시지를 생성할 책임
- [x] 게임 결과를 알려주면 결과 메시지를 생성하는 기능
  - [x] `낫싱`
  - [x] 볼만 존재하는 경우: `1볼`
  - [x] 스트라이크만 존재하는 경우: `1스트라이크`
  - [x] 볼과 스트라이크가 모두 존재하는 경우: `1볼 1스트라이크`
    - 가운데 공백으로 구분한다

### GameService: 게임 운영에 필요한 기능들을 제공할 책임
- [x] 컴퓨터를 생성해주는 기능
- [x] 심판에게 판정을 요청해 결과를 받아오는 기능
- [x] 게임이 끝났는지(3스트라이크) 알려주는 기능
- [x] 게임 재시작 여부를 알려주는 기능

### GameCommand: 게임 진행에 필요한 명령을 관리할 책임
- [x] 재시작 여부를 알려주는 기능

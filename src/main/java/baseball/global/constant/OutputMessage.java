...
public class OutputMessage {
    public static final String GAME_START_MEESAGE = "숫자 야구 게임을 시작합니다.";
    ...
    public static final String GAME_RESULT_MESSAGE = "%d볼 %d스트라이크";
    public static final String NOTHING_MESSAGE = "낫싱";
    public static final String BALL_MESSAGE = "%d볼";
    public static final String STRIKE_WITH_BALL_MESSAGE = " %d스트라이크";
    public static final String STRIKE_WITHOUT_BALL_MESSAGE = "%d스트라이크";
}

...
public class Umpire {
    ...
    public static int countStrike(final int originNumber, final int testNumber) {
        String[] origin = StringInputConverter.toArray(IntegerInputConverter.toString(originNumber));
        String[] test = StringInputConverter.toArray(IntegerInputConverter.toString(testNumber));

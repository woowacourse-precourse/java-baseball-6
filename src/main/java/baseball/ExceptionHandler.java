...
public class CheckException {
    ...
    public void checkValueInGame(String inputValue){
        checkLen(inputValue);
        checkOnlyNum(inputValue);
        checkDifNum(inputValue);
    }

    // 오직 숫자만
    private void checkOnlyNum(String inputValue) {
    ...
    // 서로 다른 숫자
    private void checkDifNum(String inputValue) {
        char[] values = inputValue.toCharArray();
    ...
    // 3자리
    private void checkLen(String inputValue) {

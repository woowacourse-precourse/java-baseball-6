...
public class InputValidation {
    ...
    public static LinkedHashSet<Integer> checkSetLength(LinkedHashSet<Integer> set) {
        if (set.size() != 3) {
    ...
    public static LinkedHashSet<Integer> checkInputNumber(String input) {
    ...
    public static ArrayList<Integer> startInput() {

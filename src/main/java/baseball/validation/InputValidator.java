...
public class InputValidator {
    ...
    /*
     * 입력받은 값이 VALIDATION_MIN_VALUE부터 VALIDATION_MAX_VALUE사이만 존재하는지 유효성 검사
     * 매개변수 : 유저에게 입력받은 값
     * VALIDATION_MIN_VALUE부터부터 VALIDATION_MAX_VALUE사이 값이 아닌 경우 IllegalArgumentException 발생
     */
    private static void validateInputIsOneToNine(List<Integer> inputValue) {
        // TODO: 입력받은 값이 VALIDATION_MIN_VALUE부터 ALIDATION_MAX_VALUE사이 값인지 유효성 검사
    }
}

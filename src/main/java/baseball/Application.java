...
public class Application {
    private static final String GAME_TERMINATION_CONDITION_STR = "3스트라이크";
    private static final String INPUT_NUMBER_STR = "숫자를 입력해주세요 : ";
    private static final String END_GAME_COMMENT_STR = "3개의 숫자를 모두 맞히셨습니다! 게임 종료";
    private static final String GAME_PROGRESS_SELECTION_STATUS_STR = "게임을 새로 시작하려면 1, 종료하려면 2를 입력하세요.";
    private static final Integer WANT_AGAIN_GAME_NUM = 1;
    private static final Integer NOT_AGAIN_GAME_NUM = 2;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            while (Utill.isNotSameString(resultStr, GAME_TERMINATION_CONDITION_STR)) {
    ...
    private static boolean isNotProceedGame() {
        ...
        System.out.println(END_GAME_COMMENT_STR); // 1. "3개의 숫자를 모두 맞히셨습니다! 게임 종료"
        System.out.println(GAME_PROGRESS_SELECTION_STATUS_STR); // 2. "게임을 새로 시작하려면 1, 종료하려면 2를 입력하세요."

        // 3. 숫자를 입력받는다.
        inputInt = Utill.inputIntNum();

        // 4. 입력 받는 숫자가 1이면 true
        if (Utill.isSameInteger(inputInt, WANT_AGAIN_GAME_NUM)) {
            return false;
        } else if (Utill.isSameInteger(inputInt, NOT_AGAIN_GAME_NUM)) {
    ...
    private static List<Integer> inputRanNumOfUser() {
        ...
        String inputStrArr[] = new String[3];

        System.out.print(INPUT_NUMBER_STR); // 1. 입력을 받기 전 출력 문구 "숫자를 입력해주세요 : "

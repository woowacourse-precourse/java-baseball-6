...
public class Application {
    ...
    private static void mainLoop() {
        ...
        while (true) {
            makeRandomNumberList(computer);   // 랜덤한 서로 다른 세 자리 수 생성
            subLoop(computer);

            System.out.println("게임을 새로 시작하려면 1, 종료하려면 2를 입력하세요.");  // 종료 분기
    ...
    private static void subLoop(List computer) {
    ...
    private static void makeRandomNumberList(List list) { // 랜덤한 서로 다른 세 자리 수 생성
        list.clear();   // 배열 초기화

...
public class Application {
    ...
    static int[] convert(String line) throws IllegalArgumentException{
    ...
    static String getResultPrompt(int ballCount, int strikeCount){
    ...
    static boolean userTry(String inputLine){

...
public class Application {
    public static void main(String[] args) {
        ...
        while(isAnswer) {
            playerNumbers = Arrays.stream(getValidatedInput()).toList();
            isAnswer = playGame();
        }
    ...
    private static String[] getValidatedInput(){
        ...
        if(Objects.equals(letters[0], letters[1]) || Objects.equals(letters[0], letters[2]) || Objects.equals(letters[1], letters[2])){

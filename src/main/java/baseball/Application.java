...
public class Application {
    ...
    public static void exceptionLength(String input) throws IllegalArgumentException{
    ...
    public static void baseballGame(List<Integer> ans) throws IllegalArgumentException{
        String result = "";

...
public class Application {
    ...
    private static List<Integer> trueRandom() {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i <= 2; i++) {
            for (int j = 0; j <= 2; j++) {
                if (computer.get(i).equals(userNumberS.get(i))) {st += 1; break; }
                else if (computer.get(i).equals(userNumberS.get(j))) {ball += 1; break;}
                else {count++;}
            }
        }

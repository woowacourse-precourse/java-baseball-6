...
public class UserInputHandler {
    ...
    public static void validInputNumber(String inputNumber) {
        ...
        if(inputNumber.charAt(0) == inputNumber.charAt(1)) throw new IllegalArgumentException();
        if(inputNumber.charAt(0) == inputNumber.charAt(2)) throw new IllegalArgumentException();
        if(inputNumber.charAt(1) == inputNumber.charAt(2)) throw new IllegalArgumentException();

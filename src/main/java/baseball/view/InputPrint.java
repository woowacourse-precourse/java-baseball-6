...
import baseball.controller.ErrorCatcher;
...
public class InputPrint{
    public static List<Integer> ballInput(int maxBallSize, int minimumNum, int maximumNum){
        ...
        ErrorCatcher.ballErrorCheck(userInput, maxBallSize, minimumNum, maximumNum);
    ...
    public static boolean isEndOfGame(){
        ...
        userInput = readLine();
        ErrorCatcher.reGameErrorCheck(userInput);
        if (userInput.equals("1")) return false;
        else return true;
    }
}

...
import static baseball.validator.BaseballInputValidator.validateBaseballNumbers;
import static baseball.validator.BaseballInputValidator.validateMenuNumber;
...
public class BaseballGameView {
    ...
    public String[] inputThreeNums() {
        ...
        validateBaseballNumbers(inputNums); // 입력받은 값 검증
    ...
    public String replayOrExit() {
        ...
        validateMenuNumber(decide); // 사용자가 입력한 값이 1 또는 2인지 유효성 검사

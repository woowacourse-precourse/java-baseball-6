...
public class OutputView {
    ...
    private static final String RESTART_GAME_MESSAGE = "게임을 새로 시작하려면 %s, 종료하려면 %s를 입력하세요.\n";
    private static final String ANSWER_CORRECT_MESSAGE = "3개의 숫자를 모두 맞히셨습니다! 게임 종료";

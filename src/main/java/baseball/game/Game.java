...
import static baseball.constant.GameConstant.COMPLETE_CHECK_NUM;
import static baseball.constant.GameConstant.END_VALUE;
...
import static baseball.constant.GameConstant.NOTHING_CHECK_NUM;
...
public class Game {
    final List<Integer> randomNumber;

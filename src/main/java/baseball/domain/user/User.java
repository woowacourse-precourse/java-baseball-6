...
public class User {
    // 사용자 입력수 리스트
    private static final List<Integer> userAnswerInputs = new ArrayList<>();

    // 재시작 여부 값 사용자로부터 입력받고, 검증 후, 이를 반환
    public Integer getWouldRestartGame(String userOption) throws Exception {
    ...
    public void parseUserAnswer(String userAnswer) throws Exception {

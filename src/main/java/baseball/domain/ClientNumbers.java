...
public class ClientNumbers implements Numbers {
    ...
    private void validateInputNotNumber(String inputStr) {
        char[] charArray = inputStr.toCharArray();
    ...
    private void validateInputNumberNotUnique(String inputStr) {
        char[] charArray = inputStr.toCharArray();
    ...
    private void validateInputSizeNot3(String inputStr) {

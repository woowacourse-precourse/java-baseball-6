...
public class BaseballGame {
    ...
    public void run() {
        ...
        Computer computer = new Computer(Utils.pickNumber());
        ...
        while (CLOSE != 2) {
            ...
            playBall(computerNumbers, playerNumbers, computer); // 경기 시작
        }
    }

    private void playBall(List<Integer> computerNumbers, List<Integer> playerNumbers, Computer computer) {

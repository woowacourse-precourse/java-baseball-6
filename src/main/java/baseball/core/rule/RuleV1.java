...
public class RuleV1 implements Rule {
    ...
    private void calculateStrikeScore(List<Integer> opponentNumberList, List<Integer> playerNumberList,ScoreResult scoreResult) {
    ...
    private void calculateBallScore(List<Integer> opponentNumberList, List<Integer> playerNumberList,ScoreResult scoreResult) {
        for (int i = 0; i < NumberSize.MAX_SIZE.getSize(); i++) {

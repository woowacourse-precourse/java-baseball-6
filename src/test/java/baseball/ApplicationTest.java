...
class ApplicationTest extends NsTest {
    ...
    @ParameterizedTest
    @CsvSource({ "우테코", "테코우", "코우테", "우우테테코코", "우우우우우우우우우우우우우우우우우우테코", "ウテコ", "UtEkO", "Ютеко", "யுடெகோ", "尤蒂科", "يوتيكو" })
    void 예외_테스트_문자열(String input) {
        assertThatThrownBy(() -> BaseballNumbers.validate(List.of(Integer.parseInt(input)))).isInstanceOf(IllegalArgumentException.class);
    }

...
class MessageConstantTest {
    ...
    void scoreMessage() {
        ...
        assertEquals("낫싱", messageConstant.scoreMessage(score));

        score = List.of(1, 0);
        assertEquals("1볼", messageConstant.scoreMessage(score));

        score = List.of(0, 1);
        assertEquals("1스트라이크", messageConstant.scoreMessage(score));

        score = List.of(1, 1);
        assertEquals("1볼 1스트라이크", messageConstant.scoreMessage(score));

        score = List.of(2, 1);
        assertEquals("2볼 1스트라이크", messageConstant.scoreMessage(score));
    }
    ...
    public void nothingMessageTest() {
        ...
        String result = messageConstant.scoreMessage(nothing);
    ...
    public void ballMessageTest() {
        ...
        String result = messageConstant.scoreMessage(ball);
    ...
    public void strikeMessageTest() {
        ...
        String result = messageConstant.scoreMessage(strike);
    ...
    public void bothMessageTest() {
        ...
        String result = messageConstant.scoreMessage(both);

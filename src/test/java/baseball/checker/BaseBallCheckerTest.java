...
public class BaseBallCheckerTest {
    ...
    public class checkGameResultTest {
        ...
        public void ballResultTest() {
            // when
            int resultCode = checkGameResult(ballResult, targetNumber);
        ...
        public void strikeResultTest() {
            // when
            int resultCode = checkGameResult(strikeResult, targetNumber);
        ...
        public void ballAndStrikeResultTest() {
            // when
            int resultCode = checkGameResult(ballAndStrikeResult, targetNumber);
        ...
        public void successToFindTargetNumber() {
            // when
            int resultCode = checkGameResult(targetNumber, targetNumber);

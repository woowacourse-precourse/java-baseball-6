...
class InputValidatorTest {
  ...
  @Test
  void isEqualLengthLimit()
      throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    //given
    String input = "123";
    int limit = 3;
    Method method = InputValidator.class.getDeclaredMethod("isEqualLengthLimit", String.class,
        int.class);
  ...
  @Test
  void isEqualLengthLimitWithReturnFalse()
      throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    //given
    String input = "123";
    int limit = 4;
  ...
  @Test
  void isContainOnlyDigitWithNonDigit()
      throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    //given
    String input = "12g";
    Method method = InputValidator.class.getDeclaredMethod("isContainOnlyDigit", String.class);
  ...
  @Test
  void isContainOnlyDigitWithZero()
      throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    //given
    String input = "120";
    Method method = InputValidator.class.getDeclaredMethod("isContainOnlyDigit", String.class);
  ...
  @Test
  void validateExitInputWithInputNOT1OR2()
      throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    //given
    String input = "3";

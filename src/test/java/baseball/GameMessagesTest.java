...
public class GameMessagesTest {
    ...
    public void testPrintStatusMessage() {
        // 볼 1, 스트라이크 1
        GameMessages.printStatusMessage(1, 1);
        assertEquals("1볼 1스트라이크" + System.lineSeparator(), outputStream.toString());
        outputStream.reset();

        // 볼 0, 스트라이크 3
        GameMessages.printStatusMessage(0, 3);

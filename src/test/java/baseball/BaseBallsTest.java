...
public class BaseBallsTest {
    ...
    @BeforeEach
    void beforeEach() {
        baseBalls = new BaseBalls(Arrays.asList(1, 2, 3));
    }
    ...
    void baseBall_3b() {
        ...
        assertThat(compare.getResult(BallScore.STRIKE)).isEqualTo(null);
    ...
    void baseBall_3s() {
        ...
        assertThat(compare.getResult(BallScore.BALL)).isEqualTo(null);
    }

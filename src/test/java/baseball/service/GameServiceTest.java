...
public class GameServiceTest {
    ...
    @Test
    @DisplayName("컴퓨터 숫자와 사용자 숫자를 비교하여, 2스트라이크가 나오는 케이스를 테스트한다.")
    void testTwoStrikeCase() {
        List<Integer> computerNumber = List.of(1, 2, 3);
        ...
        Assertions.assertThat(compareResult).isEqualTo("2스트라이크");
    }

    @Test
    @DisplayName("컴퓨터 숫자와 사용자 숫자를 비교하여, 3스트라이크가 나오는 케이스를 테스트한다.")
    void testThreeStrikeCase() {
        List<Integer> computerNumber = List.of(1, 2, 3);
        ...
        Assertions.assertThat(compareResult).isEqualTo("3스트라이크");
    }

    @Test
    @DisplayName("컴퓨터 숫자와 사용자 숫자를 비교하여, 1볼 1스트라이크가 나오는 케이스를 테스트한다.")
    void testOneBallOneStrikeCase() {
        List<Integer> computerNumber = List.of(1, 2, 3);
        ...
        Assertions.assertThat(compareResult).isEqualTo("1볼 1스트라이크");
    }

    @Test
    @DisplayName("컴퓨터 숫자와 사용자 숫자를 비교하여, 2볼 1스트라이크가 나오는 케이스를 테스트한다.")
    void testTwoBallOneStrikeCase() {
        List<Integer> computerNumber = List.of(1, 2, 3);
        ...
        Assertions.assertThat(compareResult).isEqualTo("2볼 1스트라이크");
    }
}

...
class ValidatorTest {
    ...
    void isValidNumbersLength_숫자_개수_예외처리_테스트(String numbers) {
        assertThatThrownBy(() -> Validator.isValidNumbersLength(numbers))
    ...
    void isValidNumbersType_숫자_자료형_예외처리_테스트(String numbers) {
        assertThatThrownBy(() -> Validator.isValidNumbersType(numbers))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void isValidNumbersRange_숫자_범위_예외처리_테스트(String numbers) {
        assertThatThrownBy(() -> Validator.isValidNumbersRange(numbers))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void isDuplicate_숫자_중복_예외처리_테스트(String numbers) {
        assertThatThrownBy(() -> Validator.isDuplicate(numbers))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void isValidRestartOrExitNumberType_재시작_또는_종료_숫자_자료형_예외처리_테스트(String numbers) {
        assertThatThrownBy(() -> Validator.isValidRestartOrExitNumberType(numbers))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void isValidRestartOrExitNumber_재시작_또는_종료_숫자_일치_여부_예외처리_테스트(String numbers) {
        assertThatThrownBy(() -> Validator.isValidRestartOrExitNumber(numbers))
                .isInstanceOf(IllegalArgumentException.class);
    }
}
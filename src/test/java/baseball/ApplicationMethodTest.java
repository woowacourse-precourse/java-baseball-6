...
class ApplicationMethodTest {
    ...
    @Test
    void validateBaseball() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException {
        //given
        List<Integer> computer = new ArrayList<>();
        ...
        //when
        Method method = Application.class.getDeclaredMethod("validateBaseball", List.class, List.class, Baseball.class);
        method.setAccessible(true);

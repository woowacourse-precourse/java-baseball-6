...
public class UserInputTest {
    ...
    void 유저_정답_입력_정상() {
        ...
        assertThat(userInputValidator.validateUserInputNumbers(userInputValidator.validateUserInputString(userInputString)))
    ...
    void 유저_정답_입력_세자리_미만_오류() {
        ...
        assertThatThrownBy(() -> userInputValidator.validateUserInputNumbers(userInputValidator.validateUserInputString(userInputString)))
                .isInstanceOf(IllegalArgumentException.class)

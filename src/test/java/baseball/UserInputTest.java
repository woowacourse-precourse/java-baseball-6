...
public class UserInputTest {
    ...
    void 유저_정답_입력_정상() {
        ...
        assertThat(userInputValidator.validateInputNumbers(userInputValidator.validateInputString(userInputString)))
    ...
    void 유저_정답_입력_null_오류() {
        ...
        assertThatThrownBy(() -> userInputValidator.validateInputString(userInputString))
    ...
    void 유저_정답_입력_세자리_미만_오류() {
        ...
        assertThatThrownBy(() -> userInputValidator.validateInputNumbers(userInputValidator.validateInputString(userInputString)))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void 유저_재시작_입력_정상() {
        ...
        assertThat(userInputValidator.validateRestartInput(userInputString))
                .isEqualTo(1);
    }
    ...
    void 유저_재시작_입력_범위초과_오류() {
        ...
        assertThatThrownBy(() -> userInputValidator.validateRestartInput(userInputString))
                .isInstanceOf(IllegalArgumentException.class)

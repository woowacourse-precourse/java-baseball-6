...
class ConsoleOutputTest extends IOTest {
	...
	void 볼() {
		...
		captureSystemOut(() -> consoleOutput.printResult(1, 0));
	...
	void 스트라이크() {
		...
		captureSystemOut(() -> consoleOutput.printResult(0, 1));
		assertEquals(expectedOutput, getCapturedOutput());
	}
	...
	void 볼스트라이크() {
		...
		captureSystemOut(() -> consoleOutput.printResult(1, 1));
		assertEquals(expectedOutput, getCapturedOutput());
	}
	...
	void 낫싱() {
		...
		captureSystemOut(() -> consoleOutput.printResult(0, 0));
		assertEquals(expectedOutput, getCapturedOutput());
	}
}

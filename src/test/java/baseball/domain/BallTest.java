...
public class BallTest {
    ...
    void Ball_STRIKE상황() {
        ...
        assertThat(ball.play(ball2)).isEqualTo(BallStatus.STRIKE);
    }
    ...
    void Ball_BALL상황() {
        ...
        assertThat(ball.play(ball2)).isEqualTo(BallStatus.BALL);
    }
    ...
    void Ball_NOTHING상황() {
        ...
        assertThat(ball.play(ball2)).isEqualTo(BallStatus.NOTHING);
    }
}

...
public class OutputViewTest {
    ...
    void 연산_결과_출력_테스트() {
        ...
        assertThat(os.toString()).isEqualTo("1볼 \n");

        os = computerResult();
        OutputView.printBaseballResult(0, 1);
        assertThat(os.toString()).isEqualTo("1스트라이크\n");

        os = computerResult();
        OutputView.printBaseballResult(1, 1);
        assertThat(os.toString()).isEqualTo("1볼 1스트라이크\n");

        os = computerResult();
        OutputView.printBaseballResult(0, 0);
        assertThat(os.toString()).isEqualTo("낫싱\n");
    }
}